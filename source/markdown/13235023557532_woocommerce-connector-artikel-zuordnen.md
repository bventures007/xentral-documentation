...
Du erreichst die Artikelzuordnung unter dem Pfad **Einstellungen > Verkaufen > Shops/Marktplätze >WooCommerce Connector > Artikelzuordnung**.

![image-20240223-080827.png](https://help.xentral.com/hc/article_attachments/15365058016668)
...
![connect_assignproduct_testrun1.png](https://help.xentral.com/hc/article_attachments/15365042825372)

… und anschließend auf **Artikelliste aufbauen**:

![connect_assignproduct_testrun2.png](https://help.xentral.com/hc/article_attachments/15365087676188)

Der Status des Imports wird dir anschließend oben im Fenster angezeigt:

![connect_assignproduct_testrun3.png](https://help.xentral.com/hc/article_attachments/15365058191516)

## Produktivmodus

Für den Produktivmodus kannst du die synchronisierten Artikel bei Bedarf über die Filterfunktion einschränken, z. B. wenn dein Xentral mehr Artikel enthält als du im Shop/Marktplatz anbieten möchtest. Gib dazu die Filter deiner Wahl ein. Wie du die Filter korrekt nutzt, erklären wir im Abschnitt[Filternomenklatur](#UUID-2e1a76ae-2150-3aca-98cf-7f80d6c6f0b7_UUID-cea99fc4-4ca0-d16b-7325-57c87180680c). Aktualisiere die Auswahl durch Klicken auf **Filter anwenden**...

![connect_assignitems_livemode1.png](https://help.xentral.com/hc/article_attachments/15365103504540)

… und anschließend auf **Artikelliste aufbauen**:

![connect_assignitems_livemode2.png](https://help.xentral.com/hc/article_attachments/15365072175644)

Der Status des Imports wird dir anschließend oben im Fenster angezeigt:

![connect_assignitems_livemode3.png](https://help.xentral.com/hc/article_attachments/15365043010844)

## Filternomenklatur

Zum Filtern stehen dir vielfältige Möglichkeiten zur Verfügung.

![connect_filternomenclature_numberedoverview.png](https://help.xentral.com/hc/article_attachments/18670853635228)
...
Nur noch ein paar Schritte und du kannst deine Anbindung nutzen. Gehe nun in der Verwaltung auf[Workflows](https://help.xentral.com/hc/de/articles/13234992002460#UUID-2da1fca7-0bf6-4ed1-5caa-064075c28cd0), um Details zu den synchronisierten Features zu konfigurieren.

![image-20240223-082832.png](https://help.xentral.com/hc/article_attachments/15365064937116)
