...
Du erreichst die Artikelzuordnung unter dem Pfad **Einstellungen > Verkaufen > Shops/Marktplätze >Shopware6 Connector > Artikelzuordnung**.

![image-20240223-080827.png](https://help.xentral.com/hc/article_attachments/15365079626140)
...
![connect_assignproduct_testrun1.png](https://help.xentral.com/hc/article_attachments/15365079674652)

… und anschließend auf **Artikelliste aufbauen**:

![connect_assignproduct_testrun2.png](https://help.xentral.com/hc/article_attachments/15365079727772)

Der Status des Imports wird dir anschließend oben im Fenster angezeigt:

![connect_assignproduct_testrun3.png](https://help.xentral.com/hc/article_attachments/15365106980636)

## Produktivmodus

Für den Produktivmodus kannst du die synchronisierten Artikel bei Bedarf über die Filterfunktion einschränken, z. B. wenn dein Xentral mehr Artikel enthält als du im Shop/Marktplatz anbieten möchtest. Gib dazu die Filter deiner Wahl ein. Wie du die Filter korrekt nutzt, erklären wir im Abschnitt[Filternomenklatur](#UUID-cfece960-9538-6fea-fdc4-64d9bbdfe08f_UUID-cea99fc4-4ca0-d16b-7325-57c87180680c). Aktualisiere die Auswahl durch Klicken auf **Filter anwenden**...

![connect_assignitems_livemode1.png](https://help.xentral.com/hc/article_attachments/15365095234460)

… und anschließend auf **Artikelliste aufbauen**:

![connect_assignitems_livemode2.png](https://help.xentral.com/hc/article_attachments/15365091672732)

Der Status des Imports wird dir anschließend oben im Fenster angezeigt:

![connect_assignitems_livemode3.png](https://help.xentral.com/hc/article_attachments/15365075470364)

## Filternomenklatur

Zum Filtern stehen dir vielfältige Möglichkeiten zur Verfügung.

![connect_filternomenclature_numberedoverview.png](https://help.xentral.com/hc/article_attachments/18670809345308)
...
Nur noch ein paar Schritte und du kannst deine Anbindung nutzen. Gehe nun in der Verwaltung auf[Workflows](https://help.xentral.com/hc/de/articles/14528034840732#UUID-b0386169-a59f-1d8d-1375-62b9ba1825d5), um Details zu den synchronisierten Features zu konfigurieren.

![image-20240223-082832.png](https://help.xentral.com/hc/article_attachments/15365107246876)
