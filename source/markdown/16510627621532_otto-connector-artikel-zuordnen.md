...
![connect_artikelzuordnung_otto.png](https://help.xentral.com/hc/article_attachments/18670852701212)
...
![connect_assignproduct_testrun1.png](https://help.xentral.com/hc/article_attachments/18670808770716)

… und anschließend auf **Artikelliste aufbauen**:

![connect_assignproduct_testrun2.png](https://help.xentral.com/hc/article_attachments/18670808771612)

Der Status des Imports wird dir anschließend oben im Fenster angezeigt:

![connect_assignproduct_testrun3.png](https://help.xentral.com/hc/article_attachments/18670852703388)

## Produktivmodus

Für den Produktivmodus kannst du die synchronisierten Artikel bei Bedarf über die Filterfunktion einschränken, z. B. wenn dein Xentral mehr Artikel enthält als du im Shop/Marktplatz anbieten möchtest. Gib dazu die Filter deiner Wahl ein. Wie du die Filter korrekt nutzt, erklären wir im Abschnitt[Filternomenklatur](#UUID-eecfb261-6503-5309-fcae-89ad123f65c3_UUID-cea99fc4-4ca0-d16b-7325-57c87180680c). Aktualisiere die Auswahl durch Klicken auf **Filter anwenden**...

![connect_assignitems_livemode1.png](https://help.xentral.com/hc/article_attachments/18670808773020)

… und anschließend auf **Artikelliste aufbauen**:

![connect_assignitems_livemode2.png](https://help.xentral.com/hc/article_attachments/18670852704668)

Der Status des Imports wird dir anschließend oben im Fenster angezeigt:

![connect_assignitems_livemode3.png](https://help.xentral.com/hc/article_attachments/18670852705180)

## Filternomenklatur

Zum Filtern stehen dir vielfältige Möglichkeiten zur Verfügung.

![connect_artikelzuordnung_filternomenklatur_otto.png](https://help.xentral.com/hc/article_attachments/18670852706588)
...
Nur noch ein paar Schritte und du kannst deine Anbindung nutzen. Gehe nun in der Verwaltung auf[Workflows](https://help.xentral.com/hc/de/articles/16510599518876#UUID-91f7b739-70c3-735c-3269-c7b31a73b85a), um Details zu den synchronisierten Features zu konfigurieren.

![connect_artikelzuordnung_weiter-zu-workflows.png](https://help.xentral.com/hc/article_attachments/18670852709660)
