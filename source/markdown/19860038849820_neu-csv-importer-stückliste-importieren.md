...
Mit der hier beschriebenen Funktion kannst du Stücklisten, die in einer CSV-Datei vorliegen, in deinen XentralArtikelstamm hinzufügen.

> **Warnung**
>
> Stelle sicher, dass die Artikel, zu denen du Stücklisten hochladen möchtest (Eltern-Artikel), sowie die Komponenten, die enthalten sein sollen (Kind-Artikel), bereits in Xentral angelegt sind. Falls du zunächst Artikel importieren möchtest, folgediesem Link, um zur Anleitung zu gelangen. Bei den Eltern-Artikeln sollte der Haken **Stückliste** im Artikelstamm bereits gesetzt sein.

Du findest den CSV-Importer im Menü **Einstellungen > Administration > Datenaustausch > CSV-Importer**.

![CSV-Importer_Menupfad.png](https://help.xentral.com/hc/article_attachments/19860073772060)

Der Import von Stücklisten über den CSV-Importer läuft nach folgendem Prozess ab:

![Freifelderimport_Workflow.png](https://help.xentral.com/hc/article_attachments/19860073776796)
...
- Komponenten-Artikelnummer
- Übergeordnete Produkt-Artikelnummer
- Artikelmenge

Stelle außerdem sicher, dass im Artikelstamm der Haken "Stückliste" bei allen Artikel gesetzt ist, zu denen du Stücklisten importieren möchtest.
...
![CSV-Importer_NeuenImportErstellen__1_.png](https://help.xentral.com/hc/article_attachments/19860051674268)
...
![Import_Spaltenkonfiguration_UrsprunglicherFeldname.png](https://help.xentral.com/hc/article_attachments/19860051675804)
...
![Import_SpaltenzuordnungBenutzerdefinierterText.png](https://help.xentral.com/hc/article_attachments/19860051678236)
...
![Import_SpaltenzuordnungAndern.png](https://help.xentral.com/hc/article_attachments/19860051680796)

Nachdem du eine andere Spalte ausgewählt hast, bestätige per Klick auf **Übernehmen**:

![Artikelimport_SpaltenzuordnungUbernehmen.png](https://help.xentral.com/hc/article_attachments/19860051682844)
...
![Import_DatenvalidierungGrun.png](https://help.xentral.com/hc/article_attachments/19860051683612)
...
![Artikelimport_ImportstatusNeuladen.png](https://help.xentral.com/hc/article_attachments/19860051692700)

Nach erfolgreichem Abschluss des Imports ist der Status für alle Datensätze grün:

![Artikelimport_ImportstatusVollstandig.png](https://help.xentral.com/hc/article_attachments/19860073787292)
